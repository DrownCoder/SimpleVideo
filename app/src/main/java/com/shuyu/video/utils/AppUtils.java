...
public class AppUtils {
    ...
    public static int getAppVersion() {
        try {
            PackageInfo info = MyApplication.getApplication().getPackageManager().getPackageInfo(
                    MyApplication.getApplication().getPackageName(), 0);
    ...
    public static String getAppName() {
        try {
            ...
            return MyApplication.getApplication().getResources().getString(labelRes);
        } catch (NameNotFoundException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String getIMSI() {
        TelephonyManager mTelephonyMgr = (TelephonyManager)
                MyApplication.getApplication().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getUUID() {
        String androidId = Settings.Secure.getString(MyApplication.getApplication().getContentResolver(),
